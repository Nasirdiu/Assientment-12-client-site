...
const Blogs = () => {
  return (
    <div className=" m-10 bg-zinc-200 ">
      ...
      <div
        tabindex="0"
        className="collapse collapse-open border border-base-300 bg-base-100 rounded-box mt-5"
      >
        <div className="collapse-title text-xl font-medium text-secondary">
      ...
      >
        ...
        <div className="collapse-content">
          <p>
            Searching allows customers to find certain products that satisfy a
            set of criteria. In the Pioneer Cycling store, we implemented two
            types of searching—simple and advanced. Simple searches allow a
            customer to search the catalog for keywords. In an advanced search,
            a customer can also search using additional product attributes such
            as manufacturer, weight range, or part number.
          </p>
        </div>
      </div>
      <div
