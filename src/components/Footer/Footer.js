...
import icon from '../.././asstes/images/Group 33011.png'
const Footer = () => {
    return (
      ...
      <footer class="footer p-10  text-white mt-10">
        <div className="flex">
          ...
          <p>
            ...
            <br />
            City in New York State, New York
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="grid grid-flow-col gap-4">
            ...
            <a href="http://facebook.com/nasir369">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
      ...
      <h1 className="text-center text-white">Copyright Car Auto Parts 2022</h1>
    </div>
    );
};
